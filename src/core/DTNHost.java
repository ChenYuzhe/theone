...
public class DTNHost implements Comparable<DTNHost> {
    ...
    public boolean checkNoContent(String content) {
        if (cacheManagement.checkNoContent(content)) {
            return true;
        } else {
            return false;
        }
    ...
    public void weightUpdate(String content) {
        cacheManagement.weightUpdate(content);
    }

    public void addCachePoint(String content) {
        cacheManagement.addCachePoint(content);
    }

    public String getContent(String content) {
        CachePoint cachePoint = cacheManagement.getCachePoint(content);
        return cachePoint.getContent();
    }

    public void hitratio() {

        cacheManagement.hitratio(this.name);
    }

    public void addTotalHit() {
        cacheManagement.setTotalHit(cacheManagement.getTotalHit() + 1);
    }

    public void addHit() {
        cacheManagement.setHit(cacheManagement.getHit() + 1);
    }
