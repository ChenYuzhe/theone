    ...
    public Message handle(Message msg, DTNHost host) {
        ...
        if (msg.getTo() == host && type.equalsIgnoreCase("ping")) {
            String id = "pong" + SimClock.getIntTime() + "-" +
                    host.getAddress();
            System.out.println("PingApplication handle " + msg.getMsgContent());
            Message m = new Message(host, msg.getFrom(), id, getPongSize(), msg.getMsgContent(), null);
    ...
    public void update(DTNHost host) {
        ...
        if (curTime - this.lastPing >= this.interval) {
            ...
            Message m = new Message(host, randomHost(), "ping" +
                    ...
                    getPingSize(), "101", null);
            System.out.println("PingApplicaion update ");
