...
public class Message implements Comparable<Message> {
     ...
     */
    //todo
    public Message(DTNHost from, DTNHost to, String id, int size, String msgContent, String msgType) {
        this.from = from;
        this.to = to;
        this.id = id;
        this.size = size;
    ...
    public Message replicate() {
        Message m = new Message(from, to, id, size, msgContent,msgType);
        m.copyFrom(this);
        return m;
    }
    ...
    public CachePoint getCachePoint() {
        return cachePoint;
    }

    public void setCachePoint(CachePoint cachePoint) {
